            ...
            <section v-show="avatarMode === 'character'" class="form-group character-library">
              ...
              <details class="character-upload">
                ...
                <div class="upload-form">
                  ...
                  <label>形象描述（中文）</label>
                  <textarea v-model.trim="newCharacterForm.appearanceZh" rows="3" placeholder="角色的造型、服装等细节" />
                  <label>形象描述（英文，可选）</label>
                  <textarea v-model.trim="newCharacterForm.appearanceEn" rows="2" placeholder="可选的英文描述" />
                  <label>声音提示（中文，可选）</label>
                  <textarea v-model.trim="newCharacterForm.voiceZh" rows="2" placeholder="如：男声，沉稳有磁性" />
                  <label>声音提示（英文/Prompt，可选）</label>
                  <textarea v-model.trim="newCharacterForm.voicePrompt" rows="2" placeholder="English voice prompt" />
